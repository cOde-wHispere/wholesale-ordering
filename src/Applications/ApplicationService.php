...
* * never changes wp_users.user_email as part of an application workflow.
  ...
  * @return true|\WP_Error
    ...
    * find_by_user_id() represents a WordPress account, not necessarily
    * a submitted application. Require an actual submitted application
    * before allowing a lifecycle transition.
      */
      if (
      ! $application
    ...
    * Review metadata records who performed the action and when.
    * Lifecycle status is stored separately by WholesaleStatus.
      */
      if (
